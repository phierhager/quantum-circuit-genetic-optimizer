...
from quantum_circuit_genetic_optimizer.circuit_helpers import generate_cnot_pairs, add_ry_rz_to_circuit, apply_cnot_operations, construct_quantum_circuit
...
def test_add_ry_rz_to_circuit():
    ...
    # Check gate types
    gate_types = [gate[0].name for gate in circuit.data]  # Get the names of the gates
